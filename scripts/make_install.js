...
let targetDir = 'H:\\Media\\SiYuan\\data\\plugins';
//********************************************************************************************
...
if (targetDir === '') {
    ...
    if (res === null || res === undefined || res.length === 0) {
        log('>>> Can not get SiYuan directory automatically');
...
//         if (cmpPath(srcPath, distDir)) {
//             log(`Good! ${targetPath} is already linked to ${distDir}`);
//         } else {
